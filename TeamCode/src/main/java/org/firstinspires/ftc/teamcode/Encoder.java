            ...
            if (gamepad1.a) {
                switch (state) {
                    ...
                    case 1:
                        ...
                        if (arm.shoulder.getPosition() == 1) { // Replace with your own position checking logic
                            state++;
                        }
                        break;
                    case 2:
                ...
                switch (state) {
                    ...
                    case 1:
                        ...
                        if (arm.shoulder.getPosition() == 0) { // Replace with your own position checking logic
                            state--;
                        }
                        break;
                    case 0:
