...
@TeleOp(name = "SingleSwerveModuleTestFR", group = "Test")
@Config
public class SwerveModuleTestFR extends CommandOpMode {


    private final PIDFController driveController = new PIDFController(0.01, 0, 0, 0);
    private final PIDFController turnController = new PIDFController(0.0048, 0.028, 0.013, 0.001);
    private SwerveModuleConfig config = new SwerveModuleConfig(0, "0FL", driveController, turnController,
            "RightFrontDrive", "RightFrontAxon", "RightFrontAnalog", 0, DcMotorSimple.Direction.REVERSE);
